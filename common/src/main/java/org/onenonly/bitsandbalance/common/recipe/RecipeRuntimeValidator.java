...
public final class RecipeRuntimeValidator {
    ...
    public static void validate(MinecraftServer server) {
        ...
        validate(failures, recipeManager, registries, level,
                ...
                grid(2, 2, stack("bitsandbalance:vertical_oak_slab"), ItemStack.EMPTY, ItemStack.EMPTY, ItemStack.EMPTY),
                "minecraft:oak_slab",
                1);
        ...
        validate(failures, recipeManager, registries, level,
                ...
                grid(2, 2, stack("bitsandbalance:vertical_oak_step"), ItemStack.EMPTY, ItemStack.EMPTY, ItemStack.EMPTY),
                "bitsandbalance:oak_step",
                1);

        validate(failures, recipeManager, registries, level,
                "vertical_step_from_vertical_slab slab->step",
                grid(2, 2, stack("bitsandbalance:vertical_oak_slab"), stack("bitsandbalance:vertical_oak_slab"), ItemStack.EMPTY, ItemStack.EMPTY),
                "bitsandbalance:vertical_oak_step",
                4);
        validate(failures, recipeManager, registries, level,
                "vertical_step_from_vertical_slab step->slab",
                grid(2, 2, stack("bitsandbalance:vertical_oak_step"), stack("bitsandbalance:vertical_oak_step"), ItemStack.EMPTY, ItemStack.EMPTY),
                "bitsandbalance:vertical_oak_slab",
                1);
    ...
    private static void validate(List<String> failures,
        ...
        ItemStack directResult = RecipeCompat.assemble(craftingRecipe, input, registries);
    ...
    private static String describe(ItemStack stack) {
        ...
        private static String describeCandidate(RecipeManager recipeManager, Level level, CraftingInput input, String recipeId) {
                ...
                for (RecipeHolder<?> holder : recipeManager.getRecipes()) {
                        ...
                        ItemStack result = RecipeCompat.assemble(craftingRecipe, input, level.registryAccess());
