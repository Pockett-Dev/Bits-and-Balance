...
public final class FabricUsageTickerClient {
    private static final Identifier HUD_LAYER_ID = Identifier.parse("bitsandbalance:usage_ticker");
    ...
    public static void init() {
        ...
        HudElementRegistry.attachElementAfter(VanillaHudElements.HOTBAR, HUD_LAYER_ID, (drawContext, deltaTracker) -> {
            ...
            GuiGraphicsExtractor gg = drawContext;
            Font font = mc.font;
    ...
    private static class TickerElement {
        ...
        void render(GuiGraphicsExtractor gg, Font font, boolean invert, float tickDelta) {
            ...
            gg.item(currDisplayStack, baseX, y);
            gg.itemDecorations(font, currDisplayStack, baseX, y, String.valueOf(currCount));
        }

        void renderCustom(
                GuiGraphicsExtractor gg,
                Font font,
                boolean invert,
                float tickDelta,
            ...
            gg.item(one, baseX, y);
            gg.itemDecorations(font, one, baseX, y, String.valueOf(count));
        }
