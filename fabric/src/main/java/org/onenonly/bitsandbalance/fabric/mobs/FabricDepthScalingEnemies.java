...
public final class FabricDepthScalingEnemies {
    ...
    public static void init() {
        // Depth Scaling Enemies now hooks real spawn finalization via mixin.
    }
    ...
    private static ArmorConfig getArmorConfig(DepthTier tier) {
        return switch (tier) {
            case DEEP -> new ArmorConfig(
                    ...
                    FabricBalanceConfig.dseDeepCopperWeight,
            ...
            case MID -> new ArmorConfig(
                    ...
                    FabricBalanceConfig.dseMidCopperWeight,
            ...
            default -> new ArmorConfig(
                    ...
                    FabricBalanceConfig.dseSurfaceCopperWeight,
