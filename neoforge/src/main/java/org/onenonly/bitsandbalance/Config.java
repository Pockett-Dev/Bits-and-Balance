...
public class Config {
    ...
    public static int usageTickerArmorOffsetX = 0;
    public static int usageTickerArmorOffsetY = 0;
    public static boolean usageTickerDebug = false;
    public static int armorHelmetStartY = 50;
    public static int armorHelmetEndY = 24;
    public static int armorChestplateStartY = 50;
    public static int armorChestplateEndY = 24;
    public static int armorLeggingsStartY = 50;
    public static int armorLeggingsEndY = 24;
    public static int armorBootsStartY = 50;
    public static int armorBootsEndY = 24;
    ...
    public static boolean enableCoalAndesiteVein = true;
    ...
    public static boolean enableImprovedWanderingTraders = true;
    public static boolean replaceVanillaTrades = false;
    public static boolean enableBuildingMaterialsTrades = true;
    public static boolean enableRareItemsTrades = true;
    public static boolean enableUtilityItemsTrades = true;
    public static boolean enableDecorativeItemsTrades = true;
