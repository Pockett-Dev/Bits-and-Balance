...
public final class GameplayConfig {
    ...
    static { BUILDER.pop(); }
        ...
        private static final ModConfigSpec.BooleanValue ENABLE_PHANTOM_SLOW_FALLING_ON_HIT_DISMOUNT = BUILDER.comment("Give players 2 seconds of Slow Falling I when a phantom carry ends after they hit the phantom during that carry.").define("enablePhantomSlowFallingOnHitDismount", true);
    static { BUILDER.pop(); }
    ...
    static void onLoad(final ModConfigEvent event) {
        ...
        Config.enablePhantomSlowFallingOnHitDismount = ENABLE_PHANTOM_SLOW_FALLING_ON_HIT_DISMOUNT.get();
