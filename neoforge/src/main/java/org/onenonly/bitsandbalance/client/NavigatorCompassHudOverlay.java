...
public class NavigatorCompassHudOverlay {
    ...
    public static void onRenderGuiPre(RenderGuiEvent.Pre event) {
        ...
        boolean holdingCompass = mainHand.getItem() == Items.COMPASS || offHand.getItem() == Items.COMPASS;
        ...
        ItemStack compass = mainHand.getItem() == Items.COMPASS ? mainHand : offHand;
        ...
        gg.text(font, rendered, x, y, 0xFFFFFFFF, true);
    }
    ...
    private static BlockPos getCompassTarget(ItemStack compass) {
        if (compass.getItem() != Items.COMPASS) return null;
