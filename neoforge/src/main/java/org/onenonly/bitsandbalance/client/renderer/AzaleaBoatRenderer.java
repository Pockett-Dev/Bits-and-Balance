...
/**
 * Custom renderer for azalea boats.
 * Uses vanilla boat models but with custom azalea textures.
 */

public class AzaleaBoatRenderer extends AbstractBoatRenderer {
    private static final Identifier AZALEA_BOAT_TEXTURE =
        Identifier.fromNamespaceAndPath(BitsAndBalance.MODID, "textures/entity/boat/azalea.png");
    private static final Identifier AZALEA_CHEST_BOAT_TEXTURE =
        Identifier.fromNamespaceAndPath(BitsAndBalance.MODID, "textures/entity/chest_boat/azalea.png");
    ...
    public AzaleaBoatRenderer(EntityRendererProvider.Context context, boolean hasChest) {
        super(context, hasChest ? AZALEA_CHEST_BOAT_TEXTURE : AZALEA_BOAT_TEXTURE);
