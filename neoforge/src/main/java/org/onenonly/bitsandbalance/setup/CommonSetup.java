...
public class CommonSetup {
    ...
    private static void registerFlammability() {
        ...
        fireBlock.setFlammable(ModBlocks.AZALEA_LOG.get(), 5, 5);
        fireBlock.setFlammable(ModBlocks.AZALEA_WOOD.get(), 5, 5);
        fireBlock.setFlammable(ModBlocks.STRIPPED_AZALEA_LOG.get(), 5, 5);
        fireBlock.setFlammable(ModBlocks.STRIPPED_AZALEA_WOOD.get(), 5, 5);
        
        // Azalea planks and derivatives
        fireBlock.setFlammable(ModBlocks.AZALEA_PLANKS.get(), 5, 20);
        fireBlock.setFlammable(ModBlocks.AZALEA_SLAB.get(), 5, 20);
        fireBlock.setFlammable(ModBlocks.AZALEA_STAIRS.get(), 5, 20);
        fireBlock.setFlammable(ModBlocks.AZALEA_FENCE.get(), 5, 20);
        fireBlock.setFlammable(ModBlocks.AZALEA_FENCE_GATE.get(), 5, 20);
        fireBlock.setFlammable(ModBlocks.AZALEA_SHELF.get(), 5, 20);
    ...
    private static void bitsandbalance$registerDerivedFlammability(FireBlock fireBlock, Block targetBlock, Block sourceSlab) {
        ...
        fireBlock.setFlammable(targetBlock, igniteOdds, burnOdds);
    }
