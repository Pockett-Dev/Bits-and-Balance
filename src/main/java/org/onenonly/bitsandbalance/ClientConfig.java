...
public class ClientConfig {
    ...
    private static final ModConfigSpec.BooleanValue PLAY_GUARDIAN_JUMPSCARE_SOUND = BUILDER
            .comment("Play the normal Elder Guardian Mining Fatigue sound even when the appearance effect is suppressed.")
    ...
    static {
        ...
        private static final ModConfigSpec.BooleanValue ENABLE_SOUL_FIRE_CANDLE_FLAMES = BUILDER
                .comment("Render blue soul-fire candle flames for lit candles placed on soul sand or soul soil.")
