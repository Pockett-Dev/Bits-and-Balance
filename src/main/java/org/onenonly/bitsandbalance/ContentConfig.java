...
public final class ContentConfig {
    ...
    private static final ModConfigSpec.BooleanValue ENABLE_GLOW_GOO_AMBIENT_SPLATTER_PARTICLES = BUILDER
            .comment("If true, placed Goo Splatter emits ambient glow particles.")
    ...
    static void onLoad(final ModConfigEvent event) {
        ...
        Config.glowGooAmbientSplatterParticlesEnabled = ENABLE_GLOW_GOO_AMBIENT_SPLATTER_PARTICLES.get();
