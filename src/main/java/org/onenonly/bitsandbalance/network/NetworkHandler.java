...
public class NetworkHandler {
    ...
    public static void register(final RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToClient(SoulFireBurnSyncPayload.TYPE, SoulFireBurnSyncPayload.STREAM_CODEC, (payload, ctx) -> {
            if (ctx.player().level().isClientSide()) {
                NetworkHandlerClient.handleSoulFireBurnSync(payload, ctx);
            }
        });
    ...
    private static void handleSitToggle(final org.onenonly.bitsandbalance.mechanics.SitPayload payload, final IPayloadContext ctx) {
        ...
        ctx.enqueueWork(() -> {
            ...
            net.minecraft.network.chat.HoverEvent hover = new net.minecraft.network.chat.HoverEvent.ShowItem(net.minecraft.world.item.ItemStackTemplate.fromNonEmptyStack(stack));
